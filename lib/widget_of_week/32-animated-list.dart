...
//AnimatedList
//https://www.youtube.com/watch?v=ZtfItHwFlZ8&list=PLjxrf2q8roU23XGwz3Km7sQZFTdB996iG&index=33&ab_channel=Flutter

class Widget32 extends StatefulWidget {
  @override
  _Widget32State createState() => _Widget32State();
}

class _Widget32State extends State<Widget32> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('#Widget 32 : Animated List'),
      ),
      body: AnimatedList(
        key: _listKey,
