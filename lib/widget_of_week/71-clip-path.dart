...
//ClipPath
//https://www.youtube.com/watch?v=oAUebVIb-7s&list=PLjxrf2q8roU23XGwz3Km7sQZFTdB996iG&index=74&ab_channel=Flutter

class Widget71 extends StatefulWidget {
  @override
  _Widget71State createState() => _Widget71State();
}

class _Widget71State extends State<Widget71> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('#Widget 71 : Clip Path'),
      ),
      body: Center(
        child: ClipPath(
